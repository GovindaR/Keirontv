	...
	<div class="center clearfix">
		...
		<div class="leftcol">
			<h1 class="grid-container">
				Welcome Kieron Sweeney !
				<span>This is your member area, please <a href="#" class="dash">click here</a> if yout want to logout.</span>
			</h1>
			<div class="grid-dashboard">
				<div>
					...
					<h3>Active subscriptions</h3>
						...
						<p><a href="add-renew-subscription.php" class="btn1 btn2">RENEW NOW !</a></p>
						</div>
				</div>
				<div>
				<h3>Helpdesk</h3>
			...
			<div class="grid-dashboard grid-dashboard1">
				<div>
					...
					<h3>Payout info</h3>
						...
						<p><a href="payout-info.php" class="btn1 btn2">CHANGE</a></p>
						</div>
				</div>
				<div>
