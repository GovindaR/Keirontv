...
<!-- video slider end -->
	...
	<div class="center clearfix">
        ...
        <h1 class="grid-container">
				<u>Payment history</u>
				<span style="margin-top: 0">You are logged-in as <strong>rsquarejs</strong>. <a href="http://kierontv.com/amember/logout?amember_redirect_url=%2Famember%2Fsignup" class="dash">Logout</a> to signup as new user.</span>
                </h1>
            <div class="tickets-wrapper">
            <h2>There are no confirmed payments for your account  <br>
            <br>
            <a href="add-renew-subscription.php" class="btn1 btn2">Add a subscription</a></h2>
            </div>
            <div class="grid-payment">
                <div class="grid-payment--row">
                Amount paid
                </div>
                <div class="grid-payment--row grid-payment--row1">
                For
                </div>
                <div class="grid-payment--row">
                Date
            ...
            <div class="grid-payment1 grid-payment">
				<div class="grid-payment--row2">
				<strong>$19.97</strong>
				</div>
				<div class="grid-payment--row2 grid-payment--row1 grid-payment--row3">
				<strong><a href="membership-plans-features.php" class="dash">Gold Membership</a></strong><br>		
					On monthly basis (For the month of April, 2013)
				</div>
				<div class="grid-payment--row2">
				31/03/2013
				</div>
				...
				<div class="grid-payment--row2">
				<a href="add-renew-subscription.php" class="btn1 btn2">Renew</a>
				</div>
			 </div>
			 <div class="grid-payment1 grid-payment">
				<div class="grid-payment--row2">
